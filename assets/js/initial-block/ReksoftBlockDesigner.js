        ...
        var ReksoftBlockDesigner = (function () {
            ...
            var addClounds = function () {
                ...
                var cloudR1 = new Cloud({
                    ...
                    url: '../assets/img/cloud_pale1.svg',
                    imgScaleParam: 1.4,
                    imgLeft: width / 2 + 400*scaleIndex,
                    imgTop: height * 0.15,
                    animationSpeed: 500000,
                    scaleIndex: scaleIndex,
                    linear: linear,
                ...
                var cloudR2 = new Cloud({
                    ...
                    url: '../assets/img/cloud_pale1.svg',
                    imgScaleParam: 1.1,
                    imgLeft: width / 2 + 600*scaleIndex,
                    imgTop: height * 0.1,
                    animationSpeed: 300000,
                    scaleIndex: scaleIndex,
                    linear: linear
                ...
                var cloudR3 = new Cloud({
                    ...
                    imgScaleParam: 0.6,
                    imgLeft: width / 2 + 700*scaleIndex,
                    imgTop: height * 0.2,
                    animationSpeed: 180000,
                    scaleIndex: scaleIndex,
                    linear: linear
